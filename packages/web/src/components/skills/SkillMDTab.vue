...
<template>
  <section>
    <h2 class="mb-4 text-2xl font-semibold text-white">SKILL.md</h2>
    ...
    <div
      v-else
      class="skill-content prose prose-invert prose-sm max-w-none overflow-x-auto break-words rounded-xl border border-gray-800 bg-[#1f1f1f] p-6"
      v-html="contentHtml"
    />
  </section>
</template>
