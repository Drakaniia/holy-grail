...
<template>
  <div class="inline-flex max-w-full overflow-x-auto rounded-lg border border-zinc-900 bg-zinc-950/80 p-1">
    <button
      v-for="tab in tabs"
      :key="tab.key"
      type="button"
      ...
      :class="activeTab === tab.key ? 'bg-zinc-800 text-white shadow-sm shadow-black/40' : ''"
